...
app.get("/viewUser", (req, res) => {
  knex("Admin")
    .select("UserID", "Username", "Password", "AdminFirstName", "AdminLastName")
    .then((Admin) => {
...
app.get("/addNewsletter", (req, res) =>
  res.render("addNewsletter", { data: "Newsletter" })
);
...
app.get("/viewNewsletter", (req, res) => {
  knex("Newsletter")
    .select("NewsletterID", "NewsletterEmail")
    .then((Newsletter) => {
      // Render the index.ejs template and pass the data
